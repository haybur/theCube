...
void fillStats() {
	...
	const double m = 2;
	spectrumValue[0] = m * fft1024.read(0) * 1000;
	spectrumValue[1] = m * fft1024.read(1) * 1000;
	spectrumValue[2] = m * fft1024.read(2, 3) * 1000;
	spectrumValue[3] = m * fft1024.read(4, 6) * 1000;
	spectrumValue[4] = m * fft1024.read(7, 10) * 1000;
	spectrumValue[5] = m * fft1024.read(11, 15) * 1000;
	spectrumValue[6] = m * fft1024.read(16, 22) * 1000;
	spectrumValue[7] = m * fft1024.read(23, 32) * 1000;
	spectrumValue[8] = m * fft1024.read(33, 46) * 1000;
	spectrumValue[9] = m * fft1024.read(47, 66) * 1000;
	spectrumValue[10] = m * fft1024.read(67, 93) * 1000;
	spectrumValue[11] = m * fft1024.read(94, 131) * 1000;
	spectrumValue[12] = m * fft1024.read(132, 184) * 1000;
	spectrumValue[13] = m * fft1024.read(185, 257) * 1000;
